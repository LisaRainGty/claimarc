...
def run(args, splits=None):
    ...
    if args.save_pred:
        ...
        torch.save({"thr": res["thr"], "val": {"p": pva, "y": yva},
                    "test": {"p": p, "y": y, "c": c,
                    "attr": [r.get("attribute_id", "") for r in sp["test"]]}}, args.save_pred)
