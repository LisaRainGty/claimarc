...
- report json: `data/final/repaired_v1/full_pair_reconstruction_llm_claimreextract_full_p0_strongweak120_lownoise40_noimg_audit_v4_20260614.report.json`
- flagged rows: `data/final/repaired_v1/full_pair_reconstruction_llm_claimreextract_full_p0_strongweak120_lownoise40_noimg_audit_flags_v4_20260614.jsonl`
...
- `flagged_rows`: `14`
- `high_flag_rows`: `4`
- `medium_or_high_flag_rows`: `14`
- `flag_severity`: `{'medium': 20, 'high': 4, 'info': 1}`
- `flag_code`: `{'enumeration_claim_evidence_extra_values': 1, 'identity_attribute_claim_lacks_value': 3, 'mechanism_contradiction_without_consumer_refute': 1, 'promote_action_but_not_main_ready': 7, 'numeric_value_judgment_used_as_refute': 6, 'price_value_not_direct_refute_requires_silver': 3, 'positive_label_missing_product_evidence_for_main': 4}`
...
- `queue`: `data/final/repaired_v1/full_pair_claim_reextract_full_p0_strongweak120_lownoise40_joint_review_queue_v1_20260614.jsonl`
- `reviews`: `data/final/repaired_v1/full_pair_reconstruction_llm_claimreextract_full_p0_strongweak120_lownoise40_noimg_v1_20260614.jsonl`
- `flagged`: `data/final/repaired_v1/full_pair_reconstruction_llm_claimreextract_full_p0_strongweak120_lownoise40_noimg_audit_flags_v4_20260614.jsonl`
- `out`: `data/final/repaired_v1/full_pair_reconstruction_llm_claimreextract_full_p0_strongweak120_lownoise40_noimg_audit_v4_20260614.report.json`
