...
- `labels`: `{0: 1373, 1: 942}`
- `claimful`: `2315`
- `claimful_labels`: `{0: 1373, 1: 942}`
- `source0`: `559`
- `claimful_source0`: `559`
- `no_claim_y1`: `0`
- `split`: `{'train': 1601, 'test': 475, 'val': 239}`
- `adjudicated_records`: `134`
- `adjudicated_labels`: `{0: 134}`
- `adjudicated_decisions`: `{'': 134}`
- `adjudicated_source0`: `134`
