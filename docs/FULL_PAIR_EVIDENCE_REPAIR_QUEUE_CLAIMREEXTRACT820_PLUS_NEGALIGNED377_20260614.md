...
- repair queue: `data/final/repaired_v1/full_pair_evidence_repair_queue_claimreextract820_plus_negaligned377_v1_20260614.jsonl`
- report: `data/final/repaired_v1/full_pair_evidence_repair_queue_claimreextract820_plus_negaligned377_v1_20260614.report.json`
...
- `source_claim_evidence_relation`: `{'insufficient': 120}`
- `source_product_evidence_found`: `{'False': 73, 'True': 47}`
...
- `attribute_objectivity`: `{'product_attribute': 120}`
- `image_count_bucket`: `{'13+': 70, '1-4': 4, '5-12': 46}`
